...
def predict_college_stats(excel_file_camp):
  ...
  salary_frequency = data[data['salary_as_fresher']>0]['salary_as_fresher'].value_counts().to_dict()
  Final_list['salary_distribution']=salary_frequency
  ...
  annotation_val_dict = {'highest': annotation_val[0], 'Average': annotation_val[1]}
  ...
  Final_list['skills_req_to_get_avg_sal']=np.unique(final_list)
  ...
  Final_list['min_no_of_projects_to_get_avg_sal']=np.median(final_list_projects).astype('int')
  ...
  annotation_val={'with Skills':average_projects_with_skills,'Without skills':average_projects_no_skills}
  ...
  annotation_val={'Skilled in DSA':average_dsa_skills,'Poor in DSA':average_with_no_dsa_skills}
