...
def get_array1():
    transformed_data = []
    placed = ['tier', 'cgpa', 'inter_gpa', 'ssc_gpa', 'internships', 'no_of_projects', 'is_participate_hackathon', 'is_participated_extracurricular', 'no_of_programming_languages', 'dsa', 'mobile_dev', 'web_dev', 'Machine Learning', 'cloud','CSE','ECE','IT','MECH']
...
def get_array2():
    transformed_data = []
    salary = ['tier', 'cgpa','internships', 'no_of_projects', 'is_participate_hackathon', 'is_participated_extracurricular', 'no_of_programming_languages', 'dsa', 'mobile_dev', 'web_dev', 'Machine Learning', 'cloud','CSE','ECE','IT','MECH']
    for index, row in tier1.iterrows():
        row_values = []
...
if file_extension == '.csv':
    tier1=pd.read_csv(file_name)
elif file_extension == '.xlsx' or file_extension == '.xls':
    tier1=pd.read_excel(file_name)
else:
    raise 'The file not in specified format'


columns_for_salary = ['tier', 'cgpa','internships', 'no_of_projects', 'is_participate_hackathon', 'is_participated_extracurricular', 'no_of_programming_languages', 'dsa', 'mobile_dev', 'web_dev', 'Machine Learning', 'cloud','CSE','ECE','IT','MECH']
