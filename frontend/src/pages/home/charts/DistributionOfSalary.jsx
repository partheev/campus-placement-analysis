        ...
        >
            <Container maxWidth='lg'>
                <HeadText style={{ marginBottom: '3rem' }}>
                    A Comparative Analysis on Tier-wise Student Salary
                    Distribution{' '}
                </HeadText>
                <SideText>
                    In the tier spectrum, Tier 1 and 2 favor mid-range salaries,
                    while Tier 3 leans to lower pay, reflecting diverse student
                    package acquisition.
                </SideText>
                ...
                >
                    <Chart
                        img='/static/charts/distribution_tier1_mobile.png'
                        tier={1}
                    />
                    <Chart
                        img='/static/charts/distribution_tier2_mobile.png'
                        tier={2}
                    />
                    <Chart
                        img='/static/charts/distribution_tier3_mobile.png'
                        tier={3}
                    />
                </div>
            </Container>
